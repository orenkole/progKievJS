...
let filterCountries = (countries) => {
    let nameToFilter = $('.name').val();
    let capitalToFilter = $('.capital').val();

    let filteredCountries = [];
    for(let index in countries) {
        if (countries[index]['name'].toLowerCase().includes(nameToFilter.toLowerCase()) && countries[index]['capital'].toLowerCase().includes(capitalToFilter.toLowerCase())) {
